...
public:
    ...
    double getTriDist(uint i, int tri) const;
    ...
    std::vector<int> getTriIdxs(TmPatch * tmpatch) const;

    /*
    inline int getTri0Idx(void) const
    { return getTriIdx(0); }

    inline int getTri1Idx(void) const
    { return getTriIdx(1); }

    inline int getTri2Idx(void) const
    { return getTriIdx(2); }
     */

    /*
    int getTriIdx(uint i) const;
     */

    ////////////////////////////////////////////////////////////////////////
    // NEIGHBOURING BAR INFORMATION
    ////////////////////////////////////////////////////////////////////////

    double getBarLength(uint i) const;

    inline double getBar0Length(void) const
    { return getBarLength(0); }

    inline double getBar1Length(void) const
    { return getBarLength(1); }

    inline double getBar2Length(void) const
