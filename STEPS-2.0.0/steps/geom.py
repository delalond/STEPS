...
#  Last Changed Rev:  $Rev: 490 $
#  Last Changed Date: $Date: 2013-04-22 11:27:36 +0900 (Mon, 22 Apr 2013) $
...
class Memb(steps_swig.Memb):
    ...
    def __init__(self, *args, **kwargs):
        """
            ...
            1 = principle axis ordering (quick to set up but usually results in slower simulation than method 2). 
