...
class GHKcurr(steps_swig.GHKcurr) :
    ...
    """
        ...
        that describes a current through a channel in a particular state. 
        ...
        * the 'inner' concentration of the ion
        ...
        A GHK current involves a real transfer of ions between comparments 
    ...
    def __init__(self, *args, **kwargs): 
        """
            ...
            * bool computeflux
            ...
            NOTE: function setPInfo must be called on the object before creating simulation object.
            """
